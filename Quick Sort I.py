...
cards=[55,16,2,70,0,1]
print('original version', cards)
quick_sort(cards)
print('sorted version', cards)

#Assignment: add code,(print) to explain how the if functions work.
#Write in papper how function works
